    ...
    for word in text.split(' '):
        if word.upper() in operations.keys():
            try:
                ...
                list.delete(0,END)
                list.insert(END,'Oops! Something went wrong... Please Enter Again')
            finally:
                break
...
l1 = Label(win, text='Welcome To Smart CalC!',width=20,padx=3)
l1.place(x=150,y=10)
l2 = Label(win, text='Lets Do The Math!!',padx=3)
l2.place(x=180,y=40)
